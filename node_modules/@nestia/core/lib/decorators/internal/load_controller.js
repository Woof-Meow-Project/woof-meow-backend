...
var load_controllers = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, SourceFinder_1.SourceFinder.find({
                    ...
                    filter: EXTENSION === "ts"
                        ...
                        : function (flle) { return flle.substring(flle.length - 3) === ".js"; },
                })];
            case 1:
                sources = _b.sent();
                return [2 /*return*/, mount(sources)];
        }
    });
}); };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    file = sources_1_1.value;
                    return [4 /*yield*/, Promise.resolve("".concat(file)).then(function (s) { return __importStar(require(s)); })];
                case 3:
                    external_1 = _b.sent();
                ...
                case 7:
                    ...
                    return [7 /*endfinally*/];
                case 8: return [2 /*return*/, controllers];
            }
        });
    });
}
