...
(function (FetcherBase) {
    ...
    var _Propagate = function (method) {
        return function (props) {
            return function (connection, route, input, stringify) { return __awaiter(_this, void 0, void 0, function () {
                var headers, init, path, url, response, result, _a, type, text, query, _b, _c, _d, _e;
                var _f, _g, _h, _j, _k, _l, _m;
                return __generator(this, function (_o) {
                    switch (_o.label) {
                        case 0:
                            headers = __assign({}, ((_f = connection.headers) !== null && _f !== void 0 ? _f : {}));
                            if (input !== undefined) {
                                if (((_g = route.request) === null || _g === void 0 ? void 0 : _g.type) === undefined)
                            ...
                            init = __assign(__assign({}, ((_h = connection.options) !== null && _h !== void 0 ? _h : {})), { method: route.method, headers: (function () {
                                    var e_1, _a, e_2, _b;
                                    var output = [];
                                    try {
                            ...
                            if (input !== undefined)
                                ...
                                // BODY TRANSFORM
                                ((_j = route.request) === null || _j === void 0 ? void 0 : _j.type) === "application/x-www-form-urlencoded"
                                    ? request_query_body(input)
                                    : ((_k = route.request) === null || _k === void 0 ? void 0 : _k.type) !== "text/plain"
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 11];
                        case 5:
                            if (!(((_l = route.response) === null || _l === void 0 ? void 0 : _l.type) === "application/json")) return [3 /*break*/, 7];
                            return [4 /*yield*/, response.text()];
                        case 6:
                            text = _o.sent();
                            ...
                            return [3 /*break*/, 11];
                        case 7:
                            if (!(((_m = route.response) === null || _m === void 0 ? void 0 : _m.type) === "application/x-www-form-urlencoded")) return [3 /*break*/, 9];
                            _b = URLSearchParams.bind;
                            return [4 /*yield*/, response.text()];
                        case 8:
                            query = new (_b.apply(URLSearchParams, [void 0, _o.sent()]))();
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, response.text()];
                        case 10:
                            _c.data = _e.apply(_d, [_o.sent(), result.headers]);
                            _o.label = 11;
