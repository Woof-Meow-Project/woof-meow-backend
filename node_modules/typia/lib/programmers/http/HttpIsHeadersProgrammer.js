        ...
        return function (modulo) {
            return function (type, name) {
                return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                    ...
                    StatementFactory_1.StatementFactory.constant("headers", HttpHeadersProgrammer_1.HttpHeadersProgrammer.write(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: false }) }))(modulo)(type, name)),
                    StatementFactory_1.StatementFactory.constant("output", typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("headers"), undefined, [typescript_1.default.factory.createIdentifier("input")])),
